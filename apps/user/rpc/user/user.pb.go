...
var file_apps_user_rpc_user_proto_rawDesc = string([]byte{
	...
	0x9e, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x1b, 0x0a, 0x04, 0x50, 0x69, 0x6e, 0x67,
...
var file_apps_user_rpc_user_proto_depIdxs = []int32{
	...
	2, // 6: User.Ping:output_type -> Response
	4, // 7: User.Login:output_type -> LoginResp
	6, // 8: User.Register:output_type -> RegisterResp
	8, // 9: User.GetUserInfo:output_type -> GetUserInfoResp
