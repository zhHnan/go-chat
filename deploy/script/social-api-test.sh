...
reso_addr='registry.cn-hangzhou.aliyuncs.com/hnz-chat/social-api-dev'
tag='latest'

container_name='hnz-chat-social-api-dev'
...
sleep 5
echo "检查服务注册状态:"
docker exec etcd etcdctl get --prefix "social.api"